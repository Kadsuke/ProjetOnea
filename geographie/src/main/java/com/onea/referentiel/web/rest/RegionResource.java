...
import com.onea.referentiel.repository.RegionRepository;
import com.onea.referentiel.service.RegionService;
...
/**
 * REST controller for managing {@link com.onea.referentiel.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
    ...
    private static final String ENTITY_NAME = "geographieRegion";
