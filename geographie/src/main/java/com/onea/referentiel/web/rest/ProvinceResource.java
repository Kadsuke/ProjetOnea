...
import com.onea.referentiel.repository.ProvinceRepository;
import com.onea.referentiel.service.ProvinceService;
...
/**
 * REST controller for managing {@link com.onea.referentiel.domain.Province}.
 */
@RestController
@RequestMapping("/api")
public class ProvinceResource {
    ...
    private static final String ENTITY_NAME = "geographieProvince";
