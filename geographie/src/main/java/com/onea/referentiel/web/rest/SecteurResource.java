...
import com.onea.referentiel.service.SecteurService;
...
/**
 * REST controller for managing {@link com.onea.referentiel.domain.Secteur}.
 */
@RestController
@RequestMapping("/api")
public class SecteurResource {
    ...
    private static final String ENTITY_NAME = "geographieSecteur";
    ...
    public ResponseEntity<SecteurDTO> updateSecteur(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, secteurDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SecteurDTO> partialUpdateSecteur(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        Optional<SecteurDTO> result = secteurService.partialUpdate(secteurDTO);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, secteurDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/secteurs")
    public ResponseEntity<List<SecteurDTO>> getAllSecteurs(Pageable pageable) {
        log.debug("REST request to get a page of Secteurs");
        Page<SecteurDTO> page = secteurService.findAll(pageable);
    ...
    public ResponseEntity<SecteurDTO> getSecteur(@PathVariable Long id) {
        ...
        Optional<SecteurDTO> secteurDTO = secteurService.findOne(id);
